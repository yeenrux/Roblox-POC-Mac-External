...
The author assumes no responsibility for how this code is used by others. Any misuse is solely the responsibility of the end user.
By using or modifying this code, you agree that you understand and accept these terms.
